        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="flex-1 space-y-8">
            ...
            <div className="space-y-6">
              <div className="inline-block px-4 py-2 bg-green-900 border border-green-700 rounded">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* ISO Certified */}
              <div className="bg-gray-800 border border-gray-700 rounded-lg p-6 hover:border-yellow-500">
              ...
              {/* Audited */}
              <div className="bg-gray-800 border border-gray-700 rounded-lg p-6 hover:border-blue-500">
                <div className="flex flex-col items-center text-center space-y-4">
              ...
              {/* SSL Secured */}
              <div className="bg-gray-800 border border-gray-700 rounded-lg p-6 hover:border-green-500">
                <div className="flex flex-col items-center text-center space-y-4">
            ...
            <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
              <div className="flex items-center gap-2 px-4 py-2 bg-green-900 border border-green-700 rounded">
                <i className="ri-bank-line text-green-400"></i>
                <span className="text-green-300 text-sm font-medium">RBI Compliant</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2 bg-blue-900 border border-blue-700 rounded">
                <i className="ri-shield-star-line text-blue-400"></i>
                <span className="text-blue-300 text-sm font-medium">SEBI Registered</span>
              </div>
              <div className="flex items-center gap-2 px-4 py-2 bg-purple-900 border border-purple-700 rounded">
